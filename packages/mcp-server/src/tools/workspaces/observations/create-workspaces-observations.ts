...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v2/workspaces/{workspace_id}/observations',
...
export const handler = async (client: Honcho, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.workspaces.observations.create(workspace_id, body)),
    );
  } catch (error) {
