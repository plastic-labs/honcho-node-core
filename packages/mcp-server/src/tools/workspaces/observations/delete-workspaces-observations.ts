...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['workspace_id', 'observation_id'],
  },
  annotations: {
    idempotentHint: true,
  },
...
export const handler = async (client: Honcho, args: Record<string, unknown> | undefined) => {
  const { workspace_id, observation_id, ...body } = args as any;
  return asTextContentResult(
    (await client.workspaces.observations.delete(workspace_id, observation_id)) as object,
  );
};
