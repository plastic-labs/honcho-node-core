...
export const handler = async (client: Honcho, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.workspaces.conclusions.list(workspace_id, body).asResponse();
  try {
