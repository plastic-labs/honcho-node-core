...
export const handler = async (client: Honcho, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(
        jq_filter,
        await client.workspaces.sessions.observations.query(workspace_id, session_id, body),
      ),
    );
  } catch (error) {
