...
import list_sessions_workspaces_observations from './workspaces/sessions/observations/list-sessions-workspaces-observations';
import delete_sessions_workspaces_observations from './workspaces/sessions/observations/delete-sessions-workspaces-observations';
import query_sessions_workspaces_observations from './workspaces/sessions/observations/query-sessions-workspaces-observations';
...
addEndpoint(list_sessions_workspaces_observations);
addEndpoint(delete_sessions_workspaces_observations);
addEndpoint(query_sessions_workspaces_observations);
