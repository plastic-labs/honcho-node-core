...
import queue_status_workspaces from './workspaces/queue-status-workspaces';
import search_workspaces from './workspaces/search-workspaces';
import trigger_dream_workspaces from './workspaces/trigger-dream-workspaces';
import create_workspaces_conclusions from './workspaces/conclusions/create-workspaces-conclusions';
import list_workspaces_conclusions from './workspaces/conclusions/list-workspaces-conclusions';
import delete_workspaces_conclusions from './workspaces/conclusions/delete-workspaces-conclusions';
import query_workspaces_conclusions from './workspaces/conclusions/query-workspaces-conclusions';
import create_workspaces_observations from './workspaces/observations/create-workspaces-observations';
import list_workspaces_observations from './workspaces/observations/list-workspaces-observations';
import delete_workspaces_observations from './workspaces/observations/delete-workspaces-observations';
import query_workspaces_observations from './workspaces/observations/query-workspaces-observations';
...
import get_context_workspaces_peers from './workspaces/peers/get-context-workspaces-peers';
...
import set_card_workspaces_peers from './workspaces/peers/set-card-workspaces-peers';
...
addEndpoint(queue_status_workspaces);
addEndpoint(search_workspaces);
addEndpoint(trigger_dream_workspaces);
addEndpoint(create_workspaces_conclusions);
addEndpoint(list_workspaces_conclusions);
addEndpoint(delete_workspaces_conclusions);
addEndpoint(query_workspaces_conclusions);
addEndpoint(create_workspaces_observations);
addEndpoint(list_workspaces_observations);
addEndpoint(delete_workspaces_observations);
addEndpoint(query_workspaces_observations);
...
addEndpoint(get_context_workspaces_peers);
addEndpoint(get_or_create_workspaces_peers);
addEndpoint(search_workspaces_peers);
addEndpoint(set_card_workspaces_peers);
